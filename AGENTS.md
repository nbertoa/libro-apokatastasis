...
- Decisiones de método permanentes: `proyecto/DECISIONES_EDITORIALES.md`.
- Preguntas personales nuevas: `proyecto/PREGUNTAS_Y_REFLEXIONES_PERSONALES.md`.

# ¿Hay que esperar confirmación para mejoras razonables?

No. Si una mejora de estructura, claridad, documentación o consistencia es claramente útil y reversible por Git, aplicarla y versionarla. No usar esta regla para ocultar cambios doctrinales sustantivos: esos deben estar argumentados y ser visibles.
