...
Los PDFs y libros completos de investigación no se guardan en Git. Permanecen en las Fuentes/biblioteca del Proyecto de ChatGPT.
...
Se trabaja directamente sobre `main`. No se crean branches, pull requests, GitHub Actions, workflows ni procesos de `assemble` salvo pedido explícito del usuario. Siempre que sea razonable, una tarea lógica debe quedar agrupada en un solo commit.
